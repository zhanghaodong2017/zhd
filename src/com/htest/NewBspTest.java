...
public class NewBspTest {
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < 200; i++) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					String url = "http://localhost:8080/bsp/JJDEKXWSucServlet";
					String param = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><callbackReq><orderid>"+uuid+"</orderid><ordertime>20160902113710</ordertime><cpid>86009070</cpid><appid>9012009938620160816174243239100</appid><fid>00031472</fid><consumeCode>160816554273</consumeCode><payfee>2000</payfee><payType>2</payType><hRet>0</hRet><status>0000</status><signMsg>fbbb02bbc5ae93f4bb5119899e419620</signMsg></callbackReq>";
		 ...
		 * ByteArrayInputStream(getXML().getBytes("UTF-8")));
	...
	public static String getXML() {
		...
		root.addElement("payfee").addText("2000");
