...
public class DZWTUTask extends TimerTask {

	@Override
	public void run() {

		Calendar calendar4 =Calendar.getInstance();
		calendar4.set(2015, 8, 1, 0, 0, 0);
		Calendar calendar5 =Calendar.getInstance();
		calendar5.set(2015, 8, 2, 0, 0, 0);
		...
		for (CNSParam cnsParam : cnsParams) {
			index++;
			DZWTU.getCmd(cnsParam.getTel(), cnsParam.getImsi(), cnsParam.getImei());
			try {
				Thread.sleep(60000);
				if(!TimeUtils.isOk()){
